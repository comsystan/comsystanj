...
//public class Csaj3DFracDimFFT<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj3DFracDimFFT<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				System.out.println("sumPower8: " + sumPowers8);
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj3DFracDimFFT.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj3DFracDimFFT.class, true);
	}
}
