...
public class Higuchi3D_Grey_SqrDiff implements Higuchi3DMethods{
	 ...
	 */
	public Higuchi3D_Grey_SqrDiff(RandomAccessibleInterval<?> rai, int numK, boolean skipZeroes, Dialog_WaitingWithProgressBar dlgProgress, StatusService statusService) {
		this.rai           = rai;
