 ...
 * File: Csaj3DFracDimHiguchi3D.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Menu(label = "3D Higuchi dimension")})
//public class Csaj3DFracDimHiguchi3D<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj3DFracDimHiguchi3D<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	}
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Higuchi3D dimension, please wait... Open console window for further info.",
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj3DFracDimHiguchi3D.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj3DFracDimHiguchi3D.class, true);
	}
}
