 ...
 * File: Csaj3DFracDimGeneralised.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Menu(label = "3D Generalised dimensions")})
//public class Csaj3DFracDimGeneralised<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj3DFracDimGeneralised<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj3DFracDimGeneralised.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj3DFracDimGeneralised.class, true);
	}
}
