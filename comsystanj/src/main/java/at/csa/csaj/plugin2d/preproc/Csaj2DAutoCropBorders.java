...
//public class Csaj2DAutoCropBorders<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj2DAutoCropBorders<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj2DAutoCropBorders.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj2DAutoCropBorders.class, true);
	}
}
