...
//public class Csaj2DFracDimMinkowski<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Csaj2DFracDimMinkowski<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllImages;
	...
	*/
	protected void startWorkflowForSingleImage() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Minkowski dimensions, please wait... Open console window for further info.",
...
//			}//b
		...
		if (optShowPlot) {			
			...
			Plot_RegressionFrame doubleLogPlot = DisplayRegressionPlotXY(lnDataX, lnDataY, isLineVisible, "Double log plot - Minkowski dimension", 
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(Csaj2DFracDimMinkowski.class, true).get().getOutput("image");
		ij.command().run(Csaj2DFracDimMinkowski.class, true);
	}
}
