 ...
 * File: Csaj2DFracDimHiguchi2D.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
menu = {
	...
	@Menu(label = "Higuchi dimension 2D")})
//public class Csaj2DFracDimHiguchi2D<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj2DFracDimHiguchi2D<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllImages;
	...
	*/
	protected void startWorkflowForSingleImage() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Higuchi2D dimensions, please wait... Open console window for further info.",
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj2DFracDimHiguchi2D.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj2DFracDimHiguchi2D.class, true);
	}
}
