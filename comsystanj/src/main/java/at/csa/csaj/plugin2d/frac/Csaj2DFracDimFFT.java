...
//	}
	...
	*/
	protected void startWorkflowForSingleImage() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing FFT dimension, please wait... Open console window for further info.",
	...
	*/
	protected void startWorkflowForAllImages() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing FFT dimensions, please wait... Open console window for further info.",
...
//		}	
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(Csaj2DFracDimFFT.class, true).get().getOutput("image");
		ij.command().run(Csaj2DFracDimFFT.class, true);
	}
}
