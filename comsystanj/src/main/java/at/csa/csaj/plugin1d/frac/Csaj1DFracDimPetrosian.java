 ...
 * File: Csaj1DFracDimPetrosian.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Petrosian dimension ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 
//public class Csaj1DFracDimPetrosian<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj1DFracDimPetrosian<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllColumns;
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Petrosian dimension, please wait... Open console window for further info.",
	...
	*/
	protected void startWorkflowForAllColumns() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Petrosian dimensions, please wait... Open console window for further info.",
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DFracDimPetrosian.class, true);
	}
}
