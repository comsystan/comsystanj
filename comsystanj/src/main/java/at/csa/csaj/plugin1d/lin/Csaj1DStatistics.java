...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Statistics ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 
//public class Csaj1DStatistics<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
...
//	private Button buttonProcessAllColumns;
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing sequence statistics, please wait... Open console window for further info.",
