...
/**
 * A {@link ContextCommand} plugin computing <Autocorrelation</a>
 * of a sequence.
 */
...
//public class Csaj1DAutoCorrelation<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
