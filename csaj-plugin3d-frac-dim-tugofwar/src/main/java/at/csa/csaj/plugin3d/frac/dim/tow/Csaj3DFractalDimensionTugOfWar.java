...
public class Csaj3DFractalDimensionTugOfWar<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
private int getPrimeNumber(){
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Csaj3DFractalDimensionTugOfWar.class, true);
	}
}
