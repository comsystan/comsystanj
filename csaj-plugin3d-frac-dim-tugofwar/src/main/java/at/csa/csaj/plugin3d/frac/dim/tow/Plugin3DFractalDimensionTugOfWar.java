...
package at.csa.csaj.plugin3d.frac.dim.tow;
...
public class Plugin3DFractalDimensionTugOfWar<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
private int getPrimeNumber(){
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin3DFractalDimensionTugOfWar.class, true);
	}
}
