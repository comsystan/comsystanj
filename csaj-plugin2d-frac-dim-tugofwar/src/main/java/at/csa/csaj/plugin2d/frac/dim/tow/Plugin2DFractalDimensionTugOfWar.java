/*-
 * #%L
 * Project: ImageJ2 plugin for computing fractal dimension with tug of war algorithm.
 * File: Plugin2DFractalDimensionTugOfWar.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * #L%
 */
package at.csa.csaj.plugin2d.frac.dim.tow;
...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Tug of war dimension", weight = 120)})
//public class Img2DFractalDimensionTugOfWar<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Plugin2DFractalDimensionTugOfWar<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
private int getPrimeNumber(){
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(Img2DFractalDimensionTugOfWar.class, true).get().getOutput("image");
		ij.command().run(Plugin2DFractalDimensionTugOfWar.class, true);
	}
}
