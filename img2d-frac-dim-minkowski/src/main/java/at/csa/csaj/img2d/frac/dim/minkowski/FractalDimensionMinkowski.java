 ...
 * File: FractalDimensionMinkowski.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = InteractiveCommand.class, 
        headless = true,
	    menuPath = "Plugins>ComsystanJ>Image(2D)>Fractal dimension - Minkowski")
...
//			}//b
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(FractalDimensionMinkowski.class, true).get().getOutput("image");
		ij.command().run(FractalDimensionMinkowski.class, true);
	}
}
