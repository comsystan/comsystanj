 ...
 * File: GeneralizedDim3D_Grey.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class GeneralizedDim3D_Grey implements GeneralizedDim3DMethods{
	 ...
	 */
	public GeneralizedDim3D_Grey(RandomAccessibleInterval<?> rai, int numBoxes, int minQ, int maxQ, String scanningType, String colorModelType, int pixelPercentage, WaitingDialogWithProgressBar dlgProgress, StatusService statusService) {
		this.rai             = rai;
	...
	public GeneralizedDim3D_Grey() {
	}

	/**
	 * This method calculates the 3D Generalized dimensions
	 * @return totals
	 */
	@Override
