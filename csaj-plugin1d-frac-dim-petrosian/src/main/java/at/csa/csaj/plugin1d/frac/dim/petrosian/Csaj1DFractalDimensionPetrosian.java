...
package at.csa.csaj.plugin1d.frac.dim.petrosian;
...
import at.csa.csaj.plugin1d.frac.dim.petrosian.util.Petrosian;
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Petrosian dimension ", weight = 190)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
//public class SequenceFractalDimensionPetrosian<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj1DFractalDimensionPetrosian<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllColumns;
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new WaitingDialogWithProgressBar("Computing Petrosian dimension, please wait... Open console window for further info.",
...
//			}
	...
	private void processSingleInputColumn (int c) {
		...
		// 0 D, 1 R2, 2 StdErr
		logService.info(this.getClass().getName() + " Petrosian dimension: " + resultValues[0]);
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DFractalDimensionPetrosian.class, true);
	}
}
