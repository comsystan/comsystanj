/*-
 * #%L
 * Project: ImageJ2 sequence plugin for computing the Permutation entropy
...
package at.csa.csaj.plugin1d.en.permen;
...
import at.csa.csaj.plugin1d.en.permen.util.PermutationEntropy;
...
//public class SequencePermutationEntropy<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DPermutationEntropy<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DPermutationEntropy.class, true);
	}
}
