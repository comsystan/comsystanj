/*-
 * #%L
 * Project: ImageJ2 sequence plugin for computing generalizeed entropies
 * File: Plugin1DGeneralisedEntropies.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin1d.en.genen;
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Generalized entropies ", weight = 320)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
//public class SequenceGeneralisedEntropies<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DGeneralisedEntropies<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DGeneralisedEntropies.class, true);
	}
}
