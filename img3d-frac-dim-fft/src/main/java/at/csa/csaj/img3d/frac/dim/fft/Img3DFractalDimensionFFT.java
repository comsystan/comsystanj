...
package at.csa.csaj.img3d.frac.dim.fft;
...
public class Img3DFractalDimensionFFT<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				System.out.println("sumPower8: " + sumPowers8);
		...
		if (choiceRadioButt_PowerSpecType != null) { //during startup it is null
			...
			// For the 1D projections max k is calculated differently
				...
				if (width > height & width > depth) {
					numOfK = width/2 - 1; //-1 because f=0 is not taken
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Img3DFractalDimensionFFT.class, true);
	}
}
