...
package at.csa.csaj.plugin1d.ent.perment;
...
import at.csa.csaj.plugin1d.ent.perment.util.PermutationEntropy;
...
public class Csaj1DPermutationEntropy<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllColumns;
	...
	*/
	...
	private void processSingleInputColumn (int c) {
		...
		// 0 Entropy
		logService.info(this.getClass().getName() + " Permutation entropy: " + resultValues[0]);
