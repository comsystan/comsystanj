...
package at.csa.csaj.plugin2d.en;
...
public class Plugin2DGeneralizedEntropies<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				}
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DGeneralizedEntropies.class, true);
	}
}
