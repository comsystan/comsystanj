/*-
 * #%L
 * Project: ImageJ2 plugin for computing 3D Kolmogorov complexity and Logical depth.
...
package at.csa.csaj.plugin3d.cplx.kc;
...
import at.csa.csaj.plugin3d.cplx.kc.util.Kolmogorov3DMethods;
import at.csa.csaj.plugin3d.cplx.kc.util.Kolmogorov3D_Grey;
...
@Menu(label = "3D Kolmogorov complexity", weight = 100)})
//public class Csaj3DKolmogorovComplexity<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj3DKolmogorovComplexity<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	}
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new WaitingDialogWithProgressBar("Computing 3D KC, please wait... Open console window for further info.",
...
//			}
	...
	private void processSingleInputVolume() {
		...
		double[] resultValues = process(rai); //rai is 3D
	...
	* Processing
	*/
	private double[] process(RandomAccessibleInterval<T> rai) { //3Dvolume
