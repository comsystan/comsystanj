/*-
 * #%L
 * Project: ImageJ2 sequence plugin for computing standard HRV measurements
...
package at.csa.csaj.plugin1d.hrv;
...
/**
 * A {@link Command} plugin computing <Standard HRV measurements</a> of a sequence.
 * according to
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Standard HRV measurements ", weight = 130)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
//public class SequenceHRV<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DHRV<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		System.out.println("Sum of percentages:" + (vlf+lf+hf));
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DHRV.class, true);
	}
}
