...
@Menu(label = "Signal"),
@Menu(label = "Surrogates", weight = 6)})
...
//		sliceLabels = new String[(int) numColumns];
	...
	private void processSingleInputColumn (int s) throws InterruptedException {
		...
		//if (selectedOption == JOptionPane.YES_OPTION) {
			...
			SignalPlotFrame pdf = new SignalPlotFrame(tableResult, cols, isLineVisible, "Surrogate signal(s)", signalTitle, xLabel, yLabel, seriesLabels);
