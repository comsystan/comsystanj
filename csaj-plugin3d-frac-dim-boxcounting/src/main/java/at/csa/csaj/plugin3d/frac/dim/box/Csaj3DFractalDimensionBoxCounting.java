 ...
 * File: Csaj3DFractalDimensionBoxCounting.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin3d.frac.dim.box;
...
@Menu(label = "3D Box counting dimension", weight = 20)})
...
//	}
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new WaitingDialogWithProgressBar("Computing 3D Box counting dimension, please wait... Open console window for further info.",
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj3DFractalDimensionBoxCounting.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj3DFractalDimensionBoxCounting.class, true);
	}
}
