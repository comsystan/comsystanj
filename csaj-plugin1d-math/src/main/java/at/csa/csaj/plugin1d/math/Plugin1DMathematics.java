/*-
 * #%L
 * Project: ImageJ2 sequence plugin for mathematical functions
...
package at.csa.csaj.plugin1d.math;
...
//public class SequenceMathematics<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DMathematics<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
	...
	private void processSingleInputColumn (int s) {
		...
		//if (selectedOption == JOptionPane.YES_OPTION) {
			if (resultValues != null) { 
				...
				SequencePlotFrame pdf = new SequencePlotFrame(tableOut, cols, isLineVisible, "Result sequence(s)", sequenceTitle, xLabel, yLabel, seriesLabels);
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DMathematics.class, true);
	}
}
