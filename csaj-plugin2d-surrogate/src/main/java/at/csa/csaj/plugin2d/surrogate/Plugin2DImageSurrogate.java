 ...
 * File: Plugin2DImageSurrogate.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * #L%
 */
package at.csa.csaj.plugin2d.surrogate;
...
/**
 * A {@link Command} plugin for constructing <surrogates</a>
 * of an image.
 */
...
public class Plugin2DImageSurrogate<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	private RandomAccessibleInterval process(RandomAccessibleInterval rai) { //one slice grey or RGB
		...
		Surrogate2D surrogate2D = new Surrogate2D();
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DImageSurrogate.class, true);
	}
}
