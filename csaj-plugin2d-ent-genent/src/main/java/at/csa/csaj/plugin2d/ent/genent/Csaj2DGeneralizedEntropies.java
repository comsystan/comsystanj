...
package at.csa.csaj.plugin2d.ent.genent;
...
@Plugin(type = ContextCommand.class, 
        ...
        @Menu(label = "Generalized entropies", weight = 160)})
//public class Img2DGeneralizedEntropies<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Csaj2DGeneralizedEntropies<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			//This dose not work with DisplayService because the JFrame is not "registered" as an ImageJ display	
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Csaj2DGeneralizedEntropies.class, true);
	}
}
