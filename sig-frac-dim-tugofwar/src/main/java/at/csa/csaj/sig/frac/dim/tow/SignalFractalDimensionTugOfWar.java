 ...
 * File: SignalFractalDimensionTugOfWar.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * #L%
 */
package at.csa.csaj.sig.frac.dim.tow;
...
import at.csa.csaj.sig.frac.dim.tow.util.TugOfWar;
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(SignalFractalDimensionTugOfWar.class, true);
	}
}
