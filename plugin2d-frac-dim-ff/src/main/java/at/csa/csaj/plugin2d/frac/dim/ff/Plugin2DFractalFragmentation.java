 ...
 * File: Plugin2DFractalFragmentation.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class Plugin2DFractalFragmentation<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}	
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DFractalFragmentation.class, true);
	}
}
