 ...
 * #L%
 */
package at.csa.csaj.plugin2d.filter;
...
public class Plugin2DImageFilter<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//					intervalF = (IterableInterval<R>) opService.filter().convolve(raiSlice, kernelMean, new OutOfBoundsBorderFactory());
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DImageFilter.class, true);
	}
}
