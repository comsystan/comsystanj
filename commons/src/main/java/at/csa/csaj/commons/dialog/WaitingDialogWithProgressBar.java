 ...
 * File: WaitingDialogWithProgressBar.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * #L%
 */
package at.csa.csaj.commons.dialog;
...
public class WaitingDialogWithProgressBar extends JDialog {
	...
	public WaitingDialogWithProgressBar(String message) {
		new WaitingDialogWithProgressBar(message, null, false, null);
	};

	public WaitingDialogWithProgressBar(String message, LogService logService, boolean isCancelable, ExecutorService exec) {
...
//							}
		...
		this.setIconImage(new ImageIcon(getClass().getResource("/images/comsystan.png")).getImage()); //18 and 32 are better than 48  
	...
	public void addMessage(String message) {
	 ...
	 public static void main(String args[]) {
		 ...
		 final WaitingDialogWithProgressBar it = new WaitingDialogWithProgressBar("Message", null, false, null);
