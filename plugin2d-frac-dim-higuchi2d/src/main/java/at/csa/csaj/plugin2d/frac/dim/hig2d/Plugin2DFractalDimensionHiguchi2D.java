...
public class Plugin2DFractalDimensionHiguchi2D<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DFractalDimensionHiguchi2D.class, true);
	}
}
