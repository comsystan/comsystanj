 ...
 * File: Higuchi2D_RGBDiff_MultDiff.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class Higuchi2D_RGBDiff_MultDiff implements Higuchi2DMethods{
	 ...
	 */
	public Higuchi2D_RGBDiff_MultDiff(RandomAccessibleInterval<?> rai, int numK, boolean skipZeroes)  {
		this.rai   = rai;
		this.numK  = numK;
		this.skipZeroes = skipZeroes;
	}

	public Higuchi2D_RGBDiff_MultDiff() {
	}
