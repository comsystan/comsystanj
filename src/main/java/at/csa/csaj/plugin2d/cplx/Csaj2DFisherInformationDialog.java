 ...
 * File: Csaj2DFisherInformationDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj2DFisherInformationDialog extends CsajDialog_2DPlugin {


	private static final long serialVersionUID = -6293876887692706757L;
	 ...
	 * Create the dialog.
	 */
	public Csaj2DFisherInformationDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("2D Fisher information measure");
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj2DFisherInformationCmd.class, false,
		...
		tableOutName = Csaj2DFisherInformationCmd.TABLE_OUT_NAME;
