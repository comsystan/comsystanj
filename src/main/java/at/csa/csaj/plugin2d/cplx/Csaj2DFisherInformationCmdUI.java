 ...
 * File: Csaj2DFisherInformationCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Menu(label = "Fisher information measure")})

public class Csaj2DFisherInformationCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj2DFisherInformationDialog dialog = null;
	...
	public void run() {
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj2DFisherInformationDialog(context(), datasetIn);
			}
