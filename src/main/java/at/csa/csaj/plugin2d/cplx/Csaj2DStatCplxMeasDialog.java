 ...
 * File: Csaj2DStatCplxMeasDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj2DStatCplxMeasDialog extends CsajDialog_2DPlugin {


	private static final long serialVersionUID = -8320925258850381701L;
	 ...
	 * Create the dialog.
	 */
	public Csaj2DStatCplxMeasDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("2D Statistical complexity measures");
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj2DStatCplxMeasCmd.class, false,
		...
		tableOutName = Csaj2DStatCplxMeasCmd.TABLE_OUT_NAME;
