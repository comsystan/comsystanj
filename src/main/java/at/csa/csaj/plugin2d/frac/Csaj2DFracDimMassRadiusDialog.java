 ...
 * File: Csaj2DFracDimMassRadiusDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj2DFracDimMassRadiusDialog extends CsajDialog_2DPluginWithRegression {

	private static final long serialVersionUID = -5063989327468864907L;
	 ...
	 * Create the dialog.
	 */
	public Csaj2DFracDimMassRadiusDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("2D Mass radius dimension");
		...
		radioButtonRasterBox    = new JRadioButton("Disc over center of mass");
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj2DFracDimMassRadiusCmd.class, false,
														...
														"spinnerInteger_NumDiscs",        spinnerInteger_NumEps, //WARNING: Exceptionally a different name
