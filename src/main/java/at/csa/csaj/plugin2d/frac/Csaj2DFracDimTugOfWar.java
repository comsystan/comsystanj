 ...
 * File: Csaj2DFracDimTugOfWar.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Tug of war dimension")})
//public class Csaj2DFracDimTugOfWar<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Csaj2DFracDimTugOfWar<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
private int getPrimeNumber(){
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(Csaj2DFracDimTugOfWar.class, true).get().getOutput("image");
		ij.command().run(Csaj2DFracDimTugOfWar.class, true);
	}
}
