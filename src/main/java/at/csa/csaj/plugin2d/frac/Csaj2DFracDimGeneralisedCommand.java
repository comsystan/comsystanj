 ...
 * File: Csaj2DFracDimGeneralisedCommand.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class Csaj2DFracDimGeneralisedCommand<T extends RealType<T>> extends ContextCommand implements Previewable {
