 ...
 * File: Csaj2DFracDimHiguchi2DCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Higuchi1D dimension 2D")})

public class Csaj2DFracDimHiguchi2DCmdUI extends ContextCommand implements Previewable{
