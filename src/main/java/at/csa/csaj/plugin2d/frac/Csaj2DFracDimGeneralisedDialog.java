 ...
 * File: Csaj2DFracDimGeneralisedDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj2DFracDimGeneralisedDialog extends CsajDialog_2DPluginWithRegression {
	 ...
	 * Create the dialog.
	 */
	public Csaj2DFracDimGeneralisedDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("2D Generalised dimensions");
