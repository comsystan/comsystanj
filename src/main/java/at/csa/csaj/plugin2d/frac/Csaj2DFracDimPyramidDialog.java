 ...
 * File: Csaj2DFracDimPyramidDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj2DFracDimPyramidDialog extends CsajDialog_2DPluginWithRegression {

	private static final long serialVersionUID = 507352109488292491L;
	...
	private JCheckBox  checkBoxShowImages;
	 ...
	 * Create the dialog.
	 */
	public Csaj2DFracDimPyramidDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("2D Pyramid dimension");

		//Add specific GUI elements according to Command @Parameter GUI elements
	    //*****************************************************************************************
	    JLabel labelShowImages = new JLabel("Show downscaled images");
	    labelShowImages.setToolTipText("Show downscaled image pyramid");
	    labelShowImages.setHorizontalAlignment(JLabel.RIGHT);
	    
		checkBoxShowImages = new JCheckBox();
		checkBoxShowImages.setToolTipText("Show downscaled image pyramid");
		checkBoxShowImages.setSelected(false);
		checkBoxShowImages.addItemListener(new ItemListener() {
			@Override
		    public void itemStateChanged(ItemEvent e) {
		    	booleanShowImages = checkBoxShowImages.isSelected();
		    	logService.info(this.getClass().getName() + " Show downscaled images option set to " + booleanShowImages);
	    ...
	    contentPanel.add(labelShowImages, gbc);
	    gbc.gridx = 1;
	    gbc.gridy = 210;
	    gbc.anchor = GridBagConstraints.WEST; //left
	    contentPanel.add(checkBoxShowImages, gbc);	
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj2DFracDimPyramidCmd.class, false,
														...
														"spinnerInteger_PyramidImages",   spinnerInteger_NumEps, //WARNING: Exceptionally a different name
														...
														"booleanShowImages",               booleanShowImages,
