...
public class Csaj2DFracDimBoxCountingDialog extends CsajDialog_2DPluginWithRegression {
	...
	public Csaj2DFracDimBoxCountingDialog(Context context, Dataset datasetIn) {
		...
		int numBoxes = Csaj2DFracDimBoxCountingCmd.getMaxBoxNumber(datasetIn.dimension(0), datasetIn.dimension(1));
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj2DFracDimBoxCountingCmd.class, false,
		...
		tableOutName = Csaj2DFracDimBoxCountingCmd.TABLE_OUT_NAME;
