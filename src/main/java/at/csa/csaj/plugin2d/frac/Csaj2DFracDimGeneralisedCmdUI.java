 ...
 * File: Csaj2DFracDimGeneralisedCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Generalised dimension")})

public class Csaj2DFracDimGeneralisedCmdUI extends ContextCommand implements Previewable{
