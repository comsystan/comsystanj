...
public class Csaj2DFracDimHiguchi1DDialog extends CsajDialog_2DPluginWithRegression {
	...
	public Csaj2DFracDimHiguchi1DDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("2D Higuchi dimension 1D");
		...
		String options[] = {"Single centered row/column", "Single meander row/column", "Mean of all rows/columns", "Mean of      4 radial lines [0-180°]", "Mean of 180 radial lines [0-180°]"};
