 ...
 * File: Csaj2DFracDimPyramid.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
//public class Csaj2DFracDimPyramid<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Csaj2DFracDimPyramid<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	}
	...
	protected void startWorkflowForSingleImage() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Pyramid dimension, please wait... Open console window for further info.",
	...
	protected void startWorkflowForAllImages() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Pyramid dimensions, please wait... Open console window for further info.",
		...
		if (isBinary) {// binary image
			...
			for (int b = 0; b < numBands; b++) { // mehrere Bands
				...
				if (optShowPlot) {
					...
					Plot_RegressionFrame doubleLogPlot = DisplayRegressionPlotXY(lnDataX, lnDataY, isLineVisible,"Double log plot - Pyramid dimension", 
...
//				meanRq = meanRq /numRq;
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(Csaj2DFracDimPyramid.class, true).get().getOutput("image");
		ij.command().run(Csaj2DFracDimPyramid.class, true);
	}
}
