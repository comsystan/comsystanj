 ...
 * File: Csaj2DLacunarityDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj2DLacunarityDialog extends CsajDialog_2DPluginWithRegression {

	private static final long serialVersionUID = -2531191749760705779L;
	 ...
	 * Create the dialog.
	 */
	public Csaj2DLacunarityDialog(Context context, Dataset datasetIn) {
		...
		int numEpsMax = Csaj2DLacunarityCommand.getMaxBoxNumber(datasetIn.dimension(0), datasetIn.dimension(1));
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj2DLacunarityCommand.class, false,
		...
		tableOutName = Csaj2DLacunarityCommand.TABLE_OUT_NAME;
