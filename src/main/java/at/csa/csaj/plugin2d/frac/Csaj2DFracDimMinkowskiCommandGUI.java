 ...
 * File: Csaj2DFracDimMinkowskiCommandGUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Minkowski dimension(New Dialog)")})

public class Csaj2DFracDimMinkowskiCommandGUI extends ContextCommand implements Previewable{
	...
	private Csaj2DFracDimMinkowskiDialog dialog = null;
		...
		if (datasetInInfo == null) {
			...
			if (!imageType.equals("Grey")) { 
				...
				SwingUtilities.invokeLater(() -> {
					if (dialog == null) {
						dialog = new Csaj2DFracDimMinkowskiDialog(context(), datasetIn);
					}
