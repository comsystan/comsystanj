...
/**
 * A {@link InteractiveCommand} plugin computing <Directional correlation dimension</a>
 * of an image.
 */
 ...
 *
 */
public class Csaj2DFracDimDirectionalCorrelation<T extends RealType<T>> extends InteractiveCommand implements Previewable {
