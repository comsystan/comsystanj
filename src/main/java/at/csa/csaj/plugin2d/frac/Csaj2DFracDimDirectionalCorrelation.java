 ...
 * File: Csaj2DFracDimDirectionalCorrelation.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
//public class Csaj2DFracDimDirectionalCorrelation<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj2DFracDimDirectionalCorrelation<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		// 0 Ds-row, 1 R2-row, 2 StdErr-row, 3 Ds-col, 4 R2-col, 5 StdErr-col, 6 Ds, 7 R2, 8 Stderr
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj2DFracDimDirectionalCorrelation.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj2DFracDimDirectionalCorrelation.class, true);
	}
}
