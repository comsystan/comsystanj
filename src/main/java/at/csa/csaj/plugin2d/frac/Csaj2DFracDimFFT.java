...
public class Csaj2DFracDimFFT<T extends RealType<T>> extends InteractiveCommand implements Previewable {
	...
	public static final String TABLE_OUT_NAME = "Table - FFT dimension";
...
//	}
	...
	*/
	protected void startWorkflowForSingleImage() {
		...
		dlgProgress = new CsajDialog_WaitingWithProgressBar("Computing FFT dimension, please wait... Open console window for further info.",
	...
	*/
	protected void startWorkflowForAllImages() {
		...
		dlgProgress = new CsajDialog_WaitingWithProgressBar("Computing FFT dimensions, please wait... Open console window for further info.",
...
//			//This dose not work with DisplayService because the JFrame is not "registered" as an ImageJ display	
	...
	private void writeToTable(int numRow, int numSlice, CsajContainer_ProcessMethod containerPM) {
	    ...
	    int s   = numSlice;	
			...
			tableOut.set("Df",          	 tableOut.getRowCount()-1, containerPM.item1_Values[1]);
...
//		}	
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(MethodHandles.lookup().lookupClass().getName()).get().getOutput("image");
