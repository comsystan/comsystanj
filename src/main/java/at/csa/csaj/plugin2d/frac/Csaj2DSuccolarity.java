...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Succolarity")})
//public class Csaj2DSuccolarity<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Csaj2DSuccolarity<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		succ[0] = succ[0]/((double)numOfScannedBoxes*1*maxPR);
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(Csaj2DSuccolarity.class, true).get().getOutput("image");
		ij.command().run(Csaj2DSuccolarity.class, true);
	}
}
