...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "2D to 1D scan")})

public class Csaj2DTo1DScanCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj2DTo1DScanDialog dialog = null;
	...
	public void run() {
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj2DTo1DScanDialog(context(), datasetIn);
			}
