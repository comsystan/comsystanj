...
/**
 * A {@link InteractiveCommand} plugin for constructing <surrogates</a>
 * of an image.
 */
 ...
 *
 */
public class Csaj2DSurrogate<T extends RealType<T>> extends InteractiveCommand implements Previewable {
