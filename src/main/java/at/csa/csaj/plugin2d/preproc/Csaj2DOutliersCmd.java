...
public class Csaj2DOutliersCmd<T extends RealType<T>> extends ContextCommand implements Previewable {
	...
	public static final String IMAGE_OUT_NAME = "Outliers image(s)";
