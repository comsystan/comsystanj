 ...
 * File: Csaj2DAutoCropBordersCmd.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class Csaj2DAutoCropBordersCmd<T extends RealType<T>> extends ContextCommand implements Previewable {
...
//			}
	...
	private void generateDataset(RandomAccessibleInterval<T> rai) {
		if (imageType.equals("Grey")) {
			...
			datasetOut = datasetService.create(dims, this.IMAGE_OUT_NAME, axes, bitsPerPixel, signed, floating, virtual);	
