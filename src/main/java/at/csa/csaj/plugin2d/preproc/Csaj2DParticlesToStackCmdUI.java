 ...
 * File: Csaj2DParticlesToStackCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class Csaj2DParticlesToStackCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj2DParticlesToStackDialog dialog = null;
	...
	public void run() {
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj2DParticlesToStackDialog(context(), datasetIn);
			}
