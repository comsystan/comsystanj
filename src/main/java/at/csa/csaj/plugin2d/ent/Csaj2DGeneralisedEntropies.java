 ...
 * File: Csaj2DGeneralisedEntropies.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
//public class Csaj2DGeneralisedEntropies<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Csaj2DGeneralisedEntropies<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			//This dose not work with DisplayService because the JFrame is not "registered" as an ImageJ display	
	...
	public static void main(final String... args) throws Exception {
		...
		//ij.command().run(Csaj2DGeneralisedEntropies.class, true).get().getOutput("image");
		ij.command().run(Csaj2DGeneralisedEntropies.class, true);
	}
}
