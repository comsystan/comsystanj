 ...
 * File: Csaj1DFracDimSevcikDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj1DFracDimSevcikDialog extends CsajDialog_1DPlugin {

	private static final long serialVersionUID = -1560259578850789458L;
	 ...
	 * Create the dialog.
	 */
	public Csaj1DFracDimSevcikDialog(Context context, DefaultTableDisplay defaultTableDisplay) {
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj1DFracDimSevcikCmd.class, false,
		...
		tableOutName = Csaj1DFracDimSevcikCmd.TABLE_OUT_NAME;
