 ...
 * File: Csaj1DFracDimWalkingDividerCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Walking divider dimension(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DFracDimWalkingDividerCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DFracDimWalkingDividerDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DFracDimWalkingDividerDialog(context(), defaultTableDisplay);
			}
