 ...
 * File: Csaj1DFracDimSevcikCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Sevcik dimension(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DFracDimSevcikCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DFracDimSevcikDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DFracDimSevcikDialog(context(), defaultTableDisplay);
			}
