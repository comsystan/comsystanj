...
//public class Csaj1DFracDimFragmentation<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj1DFracDimFragmentation<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
	...
	private static int numNumRegEnd = 1000;
...
//	private Button buttonProcessAllColumns;
	...
	protected void initialNumRegEnd() {
		...
		spinnerInteger_NumRegEnd = numNumRegEnd;
	...
	protected void callbackNumRegEnd() {
		...
		if (spinnerInteger_NumRegEnd > numNumRegEnd) spinnerInteger_NumRegEnd = numNumRegEnd; 
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Fragmentation dimensions, please wait... Open console window for further info.",
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DFracDimFragmentation.class, true);
	}
}
