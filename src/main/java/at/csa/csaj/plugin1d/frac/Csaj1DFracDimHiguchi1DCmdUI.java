 ...
 * File: Csaj1DFracDimHiguchi1DCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Higuchi dimension(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DFracDimHiguchi1DCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DFracDimHiguchi1DDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DFracDimHiguchi1DDialog(context(), defaultTableDisplay);
			}
