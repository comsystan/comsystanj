...
//public class Csaj1DFracDimRSE<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj1DFracDimRSE<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing RSE dimensions, please wait... Open console window for further info.",
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DFracDimRSE.class, true);
	}
}
