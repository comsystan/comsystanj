...
/**
 * A {@link InteractiveCommand} plugin computing <the RSE dimension</a>
* of a sequence.
 */
 ...
 */
public class Csaj1DFracDimRSE<T extends RealType<T>> extends InteractiveCommand implements Previewable {
