...
/**
 * A {@link InteractiveCommand} plugin computing <the Tug of war dimension</a>
* of a sequence.
 */
 ...
 */
public class Csaj1DFracDimTugOfWar<T extends RealType<T>> extends InteractiveCommand implements Previewable {
