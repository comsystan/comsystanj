...
/**
 * A {@link InteractiveCommand} plugin computing <the Higuchi dimension</a>
* of a sequence.
 */
 ...
 *
 */
public class Csaj1DFracDimHiguchi1D<T extends RealType<T>> extends InteractiveCommand implements Previewable {
