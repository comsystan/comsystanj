 ...
 * File: Csaj1DFracDimWalkingDivider.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Walking divider dimension ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 
//public class Csaj1DFracDimWalkingDivider<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj1DFracDimWalkingDivider<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
