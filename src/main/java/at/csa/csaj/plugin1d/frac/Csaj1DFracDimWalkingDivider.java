...
/**
 * A {@link InteractiveCommand} plugin computing <the Walking divider dimension</a>
 ...
 *
 */
public class Csaj1DFracDimWalkingDivider<T extends RealType<T>> extends InteractiveCommand implements Previewable {
