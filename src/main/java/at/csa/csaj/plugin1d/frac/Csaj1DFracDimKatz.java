...
/**
 * A {@link InteractiveCommand} plugin computing <the Katz dimension</a>
* of a sequence.
 ...
 */
public class Csaj1DFracDimKatz<T extends RealType<T>> extends InteractiveCommand implements Previewable {
