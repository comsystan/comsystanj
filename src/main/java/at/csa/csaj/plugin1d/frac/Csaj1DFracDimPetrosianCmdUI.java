 ...
 * File: Csaj1DFracDimPetrosianCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Petrosian dimension(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DFracDimPetrosianCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DFracDimPetrosianDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DFracDimPetrosianDialog(context(), defaultTableDisplay);
			}
