...
/**
 * A {@link InteractiveCommand} plugin computing <Statistics</a>
 * of a sequence.
 */
 ...
 */
public class Csaj1DStatistics<T extends RealType<T>> extends InteractiveCommand implements Previewable {
