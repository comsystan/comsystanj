 ...
 * File: Csaj1DPermutationEntropyCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Permutaion entropy(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DPermutationEntropyCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DPermutationEntropyDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DPermutationEntropyDialog(context(), defaultTableDisplay);
			}
