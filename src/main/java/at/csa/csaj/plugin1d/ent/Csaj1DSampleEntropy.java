...
//public class Csaj1DSampleEntropy<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
...
//	private Button buttonProcessAllColumns;
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing "+choiceRadioButt_EntropyType+", please wait... Open console window for further info.",
