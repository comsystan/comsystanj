...
/**
 * A {@link InteractiveCommand} plugin for cutting out a sub-sequence.
 */
 ...
 */
public class Csaj1DCutOut<T extends RealType<T>> extends InteractiveCommand implements Previewable {
