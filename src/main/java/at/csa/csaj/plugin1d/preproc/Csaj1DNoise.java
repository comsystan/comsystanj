...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Noise ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 
//public class Csaj1DNoise<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj1DNoise<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
