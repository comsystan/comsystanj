...
public class Csaj1DCutOutCmd<T extends RealType<T>> extends ContextCommand implements Previewable {
...
//			numGlidingBoxes    = numRows - spinnerInteger_BoxLength + 1;
	...
	*/
	...
	private void generateTableHeader() {
		...
		int numNewRows = spinnerInteger_RangeEnd - spinnerInteger_RangeStart + 1;
