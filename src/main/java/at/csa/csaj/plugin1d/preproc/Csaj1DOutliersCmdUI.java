...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Outliers ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DOutliersCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DOutliersDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DOutliersDialog(context(), defaultTableDisplay);
			}
