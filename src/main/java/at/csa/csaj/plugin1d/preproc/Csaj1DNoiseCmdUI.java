...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Noise(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DNoiseCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DNoiseDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DNoiseDialog(context(), defaultTableDisplay);
			}
