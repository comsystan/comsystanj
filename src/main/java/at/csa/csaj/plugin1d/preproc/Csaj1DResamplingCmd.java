...
public class Csaj1DResamplingCmd<T extends RealType<T>> extends ContextCommand implements Previewable {
	...
	*/
	...
	private void generateTableHeader() {
		...
		if      (this.choiceRadioButt_ResamplingType.equals("Down-sampling")) {
			...
			numRowsOut = (int)numRows/this.spinnerInteger_NumFactor;
		}
