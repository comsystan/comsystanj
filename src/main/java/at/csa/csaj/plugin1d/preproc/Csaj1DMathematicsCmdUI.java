 ...
 * File: Csaj1DMathematicsCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Mathematics(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DMathematicsCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DMathematicsDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DMathematicsDialog(context(), defaultTableDisplay);
			}
