...
/**
 * A {@link InteractiveCommand} plugin computing <Filtering</a>
 * of a sequence.
 */
 ...
 *
 */
public class Csaj1DFilter<T extends RealType<T>> extends InteractiveCommand implements Previewable {
