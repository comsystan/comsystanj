...
/**
 * A {@link InteractiveCommand} plugin computing <surrogates</a>
 * of a sequence.
 */
 ...
 */
public class Csaj1DSurrogate<T extends RealType<T>> extends InteractiveCommand implements Previewable {
