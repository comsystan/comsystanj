...
/**
 * A {@link ContextCommand} plugin computing <the Lyapunov exponent</a>
* of a sequence.
 */
...
//public class Csaj1DLyapunov<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DLyapunov.class, true);
	}
}
