 ...
 * File: Csaj1DKolmogorovComplexityCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Kolmogorov complexity and LD(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DKolmogorovComplexityCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DKolmogorovComplexityDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DKolmogorovComplexityDialog(context(), defaultTableDisplay);
			}
