 ...
 * File: Csaj1DFisherInformationCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Fisher information measure ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DFisherInformationCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DFisherInformationDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DFisherInformationDialog(context(), defaultTableDisplay);
			}
