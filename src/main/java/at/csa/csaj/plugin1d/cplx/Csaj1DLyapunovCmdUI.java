...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Lyapunov exponent(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DLyapunovCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DLyapunovDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DLyapunovDialog(context(), defaultTableDisplay);
			}
