 ...
 * File: Csaj1DRenyiHeterogeneitiesCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Renyi heterogeneities ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DRenyiHeterogeneitiesCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DRenyiHeterogeneitiesDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DRenyiHeterogeneitiesDialog(context(), defaultTableDisplay);
			}
