...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Porta Guzik Ehler indices(New dialog) ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DPGECmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DPGEDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DPGEDialog(context(), defaultTableDisplay);
			}
