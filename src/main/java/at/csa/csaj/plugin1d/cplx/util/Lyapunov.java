...
//			}
	 ...
	 */
	public double[] calcRegressionsMean(double[][] divergences, int numRegStart, int numRegEnd) {
		...
		for (int e = 0; e < numEps; e++) {
			regressionParams = calcRegression(divergences[e], numRegStart, numRegEnd);
			dataYs[e] = dataY;
			if (e == 0) {
	 ...
	 * @return double regression parameters
	 */
	public double[] calcRegression(double[] divergences, int numRegStart, int numRegEnd) {
	
		eps = new double[divergences.length]; //k
