...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "Rescaled auto-density RAD ")}) //Space at the end of the label is necessary to avoid duplicate with 2D plugin 

public class Csaj1DRADCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj1DRADDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj1DRADDialog(context(), defaultTableDisplay);
			}
