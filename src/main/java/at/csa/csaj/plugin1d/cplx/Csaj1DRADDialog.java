 ...
 */
public class Csaj1DRADDialog extends CsajDialog_1DPlugin {

	private static final long serialVersionUID = -6471918093009475325L;
	 ...
	 * Create the dialog.
	 */
	public Csaj1DRADDialog(Context context, DefaultTableDisplay defaultTableDisplay) {
		...
		//Title of plugin
		//Overwrite
		setTitle("1D Rescaled auto-density RAD");

		//Add specific GUI elements according to Command @Parameter GUI elements
		//*****************************************************************************************
	    labelTau = new JLabel("Tau");
	    labelTau.setToolTipText("Time lag/delay");
        ...
        spinnerTau.setToolTipText("Time lag/delay");
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj1DRADCmd.class, false,
		...
		tableOutName = Csaj1DRADCmd.TABLE_OUT_NAME;
