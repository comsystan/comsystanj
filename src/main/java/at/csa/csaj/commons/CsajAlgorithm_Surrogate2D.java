 ...
 * File: CsajAlgorithm_Surrogate2D.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * @since   2022 02
 */
public class CsajAlgorithm_Surrogate2D {
	 ...
	 */
	public CsajAlgorithm_Surrogate2D(){
...
//			//resultImg;
	...
	private RandomAccessibleInterval<FloatType> windowingRectangular (RandomAccessibleInterval<?> rai) {
		...
		Cursor<FloatType> cursorD = raiWindowed.localizingCursor();
