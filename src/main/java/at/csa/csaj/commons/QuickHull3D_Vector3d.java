 ...
 * File: QuickHull3D_Vector3d.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class QuickHull3D_Vector3d
{
	/**
	 ...
	 */
	public QuickHull3D_Vector3d (QuickHull3D_Vector3d v)
	 {
	   set (v);
	 }
	 ...
	 */
	public QuickHull3D_Vector3d (double x, double y, double z)
	 {
	   set (x, y, z);
	 }
	 ...
	 */
	public void set (QuickHull3D_Vector3d v1)
	 {
	   x = v1.x;
	   y = v1.y;
	   z = v1.z;
	 ...
	 */
	public void add (QuickHull3D_Vector3d v1, QuickHull3D_Vector3d v2)
	 {
	   x = v1.x + v2.x;
	   y = v1.y + v2.y;
	   z = v1.z + v2.z;
	 ...
	 */
	public void add (QuickHull3D_Vector3d v1)
	 {
	   x += v1.x;
	   y += v1.y;
	   z += v1.z;
	 ...
	 * @param v2 right-hand vector
	 */
	public void sub (QuickHull3D_Vector3d v1, QuickHull3D_Vector3d v2)
	 {
	   x = v1.x - v2.x;
	   y = v1.y - v2.y;
	   z = v1.z - v2.z;
	 ...
	 * @param v1 right-hand vector
	 */
	public void sub (QuickHull3D_Vector3d v1)
	 {
	   x -= v1.x;
	   y -= v1.y;
	   z -= v1.z;
	 ...
	 */
	public void scale (double s, QuickHull3D_Vector3d v1)
	 {
	   x = s*v1.x;
	   y = s*v1.y;
	   z = s*v1.z;
	 ...
	 */
	public double distance(QuickHull3D_Vector3d v)
	 {
	   double dx = x - v.x;
	   double dy = y - v.y;
	   double dz = z - v.z;
	 ...
	 */
	public double distanceSquared(QuickHull3D_Vector3d v)
	 {
	   double dx = x - v.x;
	   double dy = y - v.y;
	   double dz = z - v.z;
	 ...
	 * @return dot product
	 */
	public double dot (QuickHull3D_Vector3d v1)
	 {
	 ...
	 * @param v2 right-hand vector
	 */
	public void cross (QuickHull3D_Vector3d v1, QuickHull3D_Vector3d v2)
	 {
