 ...
 * File: Csaj1DHurstPSDCommand.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 *
 */
public class Csaj1DHurstPSDCommand<T extends RealType<T>> extends ContextCommand implements Previewable {
...
//		}
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing Hurst value, please wait... Open console window for further info.",
