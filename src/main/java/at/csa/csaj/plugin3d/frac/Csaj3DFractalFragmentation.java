...
/**
 * A {@link InteractiveCommand} plugin computing <3D fractal fragmentation indices</a>
 * of an image volume.
 */
 ...
 */
public class Csaj3DFractalFragmentation<T extends RealType<T>> extends InteractiveCommand implements Previewable {
