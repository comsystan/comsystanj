...
/**
 * A {@link InteractiveCommand} plugin computing <the 3D Higuchi dimension</a>
 * of an image volume.
 */
 ...
 */
public class Csaj3DFracDimHiguchi3D<T extends RealType<T>> extends InteractiveCommand implements Previewable {
