 ...
 * File: Csaj3DLacunarityCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "3D Lacunarity(New dialog)")})

public class Csaj3DLacunarityCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj3DLacunarityDialog dialog = null;
	...
	public void run() {	
		...
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj3DLacunarityDialog(context(), datasetIn);
			}
