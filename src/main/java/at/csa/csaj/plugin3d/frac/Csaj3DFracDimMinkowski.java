 ...
 * File: Csaj3DFracDimMinkowski.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
//	}
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing 3D Minkowski dimension, please wait... Open console window for further info.",
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj3DFracDimMinkowski.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj3DFracDimMinkowski.class, true);
	}
}
