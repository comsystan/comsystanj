...
public class Csaj3DFracDimFFTCmd<T extends RealType<T>> extends ContextCommand implements Previewable {
...
//	private Button buttonProcessAllImages;
	...
	protected void initialMaxK() {
      	numOfK = getMaxK((int)width, (int)height, (int)depth, choiceRadioButt_PowerSpecType);
    ...
    protected void initialPowerSpecType() {
		...
		int numOfK = getMaxK((int)width, (int)height, (int)depth, choiceRadioButt_PowerSpecType);
		spinnerInteger_MaxK   = numOfK;
		spinnerInteger_NumRegEnd = numOfK;	
    } 
...
//	}
	...
	protected void callbackMaxK() {
		...
		int numMaxK = getMaxK((int)width, (int)height, (int)depth, choiceRadioButt_PowerSpecType);	
...
//				System.out.println("sumPower8: " + sumPowers8);
	 ...
	 */
	public static int getMaxK(int width, int height, int depth, String choiceRadioButt_PowerSpecType) { //
