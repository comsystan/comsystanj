...
/**
 * A {@link InteractiveCommand} plugin computing <the 3D Correlation dimension</a>
 * of an image volume.
 */
 ...
 *
 */
public class Csaj3DFracDimCorrelation<T extends RealType<T>> extends InteractiveCommand implements Previewable {
