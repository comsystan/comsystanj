 ...
 * File: Csaj3DFracDimCorrelation.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
//public class Csaj3DFracDimCorrelation<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj3DFracDimCorrelation<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	}
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new Dialog_WaitingWithProgressBar("Computing 3D Correlation dimension, please wait... Open console window for further info.",
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj3DFracDimCorrelation.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj3DFracDimCorrelation.class, true);
	}
}
