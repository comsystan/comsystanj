 ...
 * File: Csaj3DFracDimBoxCountingDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj3DFracDimBoxCountingDialog extends CsajDialog_3DPluginWithRegression {

	private static final long serialVersionUID = -6328548854277174439L;
	 ...
	 * Create the dialog.
	 */
	public Csaj3DFracDimBoxCountingDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("3D Box counting dimension");
		...
		labelNumEps.setToolTipText("Number of distinct box sizes with the power of 2");
		int numBoxes = Csaj3DFracDimBoxCountingCmd.getMaxBoxNumber(width, height, depth);
		...
		spinnerNumEps.setToolTipText("Number of distinct box sizes with the power of 2");
	...
	public void processCommand() {
		...
		tableOutName = Csaj3DFracDimBoxCountingCmd.TABLE_OUT_NAME;
