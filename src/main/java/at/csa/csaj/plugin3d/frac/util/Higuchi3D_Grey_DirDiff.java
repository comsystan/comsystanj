...
public class Higuchi3D_Grey_DirDiff implements Higuchi3DMethods{
	 ...
	 */
	public Higuchi3D_Grey_DirDiff(RandomAccessibleInterval<?> rai, int numK, boolean skipZeroes, CsajDialog_WaitingWithProgressBar dlgProgress, StatusService statusService) {
		this.rai           = rai;
