...
/**
 * A {@link InteractiveCommand} plugin computing <the 3D Box counting dimension</a>
 * of an image volume.
 */
 ...
 *
 */
public class Csaj3DFracDimBoxCounting<T extends RealType<T>> extends InteractiveCommand implements Previewable {
