...
/**
 * A {@link InteractiveCommand} plugin computing <the 3D Lacunarity</a>
 * of an image volume.
 */
 ...
 */
public class Csaj3DLacunarity<T extends RealType<T>> extends InteractiveCommand implements Previewable {
