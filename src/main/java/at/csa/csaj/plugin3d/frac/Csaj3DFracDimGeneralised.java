...
/**
 * A {@link InteractiveCommand} plugin computing <the 3D Generalised dimensions</a>
 * of an image volume.
 */
 ...
 *
 */
public class Csaj3DFracDimGeneralised<T extends RealType<T>> extends InteractiveCommand implements Previewable {
