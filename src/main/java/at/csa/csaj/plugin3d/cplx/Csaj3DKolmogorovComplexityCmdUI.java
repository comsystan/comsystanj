...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "3D Kolmogorov complexity(New Dialog)")})

public class Csaj3DKolmogorovComplexityCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj3DKolmogorovComplexityDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj3DKolmogorovComplexityDialog(context(), datasetIn);
			}
