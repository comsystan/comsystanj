 ...
 * File: Csaj3DRenyiHeterogeneitiesDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj3DRenyiHeterogeneitiesDialog extends CsajDialog_3DPlugin {

	private static final long serialVersionUID = 5394025838557562624L;
	 ...
	 * Create the dialog.
	 */
	public Csaj3DRenyiHeterogeneitiesDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("3D Renyi heterogeneities");
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj3DRenyiHeterogeneitiesCmd.class, false,
		...
		tableOutName = Csaj3DRenyiHeterogeneitiesCmd.TABLE_OUT_NAME;
