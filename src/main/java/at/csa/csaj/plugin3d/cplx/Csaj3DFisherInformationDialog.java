 ...
 * File: Csaj3DFisherInformationDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj3DFisherInformationDialog extends CsajDialog_3DPlugin {

	private static final long serialVersionUID = -8557796701521752928L;
	 ...
	 * Create the dialog.
	 */
	public Csaj3DFisherInformationDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("3D Fisher information measure");
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj3DFisherInformationCmd.class, false,
		...
		tableOutName = Csaj3DFisherInformationCmd.TABLE_OUT_NAME;
