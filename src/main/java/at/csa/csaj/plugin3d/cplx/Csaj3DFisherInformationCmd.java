 ...
 * File: Csaj3DFisherInformationCmd.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
/**
 * A {@link ContextCommand} plugin computing the <3D Fisher information measure</a>
 * of an image volume.
 * 
 */
@Plugin(type = ContextCommand.class,
		headless = true,
		label = "3D Fisher information measure",
		initializer = "initialPluginLaunch",
		iconPath = "/icons/comsystan-logo-grey46-16x16.png", //Menu entry icon
		menu = {})

public class Csaj3DFisherInformationCmd<T extends RealType<T>> extends ContextCommand implements Previewable {

	private static final String PLUGIN_LABEL            = "<html><b>Computes 3D Fisher information  measure</b></html>";
	...
	public static final String TABLE_OUT_NAME = "Table - 3D Fisher information measure";
...
//	}
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new CsajDialog_WaitingWithProgressBar("Computing 3D Fisher information measure, please wait... Open console window for further info.",
