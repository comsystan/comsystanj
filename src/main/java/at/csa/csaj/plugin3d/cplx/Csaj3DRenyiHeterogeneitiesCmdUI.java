 ...
 * File: Csaj3DRenyiHeterogeneitiesCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "3D Renyi heterogeneities")})

public class Csaj3DRenyiHeterogeneitiesCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj3DRenyiHeterogeneitiesDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj3DRenyiHeterogeneitiesDialog(context(), datasetIn);
			}
