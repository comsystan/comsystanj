 ...
 * File: Csaj3DFisherInformationCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "3D Fisher information measure")})

public class Csaj3DFisherInformationCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj3DFisherInformationDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj3DFisherInformationDialog(context(), datasetIn);
			}
