...
/**
 * A {@link InteractiveCommand} plugin for constructing a <surrogate</a>
 * of an image volume.
 */
 ...
 *
 */
public class Csaj3DSurrogate<T extends RealType<T>> extends InteractiveCommand implements Previewable {
