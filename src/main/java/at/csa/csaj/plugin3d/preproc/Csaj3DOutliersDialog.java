 ...
 * File: Csaj3DOutliersDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj3DOutliersDialog extends CsajDialog_3DPlugin {

	private static final long serialVersionUID = 252875448525282914L;
	 ...
	 * Create the dialog.
	 */
	public Csaj3DOutliersDialog(Context context, Dataset datasetIn) {
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj3DOutliersCmd.class, false,
