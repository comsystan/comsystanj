...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "3D Outliers")})

public class Csaj3DOutliersCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj3DOutliersDialog dialog = null;
	...
	public void run() {	
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj3DOutliersDialog(context(), datasetIn);
			}
