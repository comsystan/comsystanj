 ...
 */
public class Csaj3DNoiseDialog extends CsajDialog_3DPlugin {
	
	private static final long serialVersionUID = -7963573814227719656L;
	 ...
	 * Create the dialog.
	 */
	public Csaj3DNoiseDialog(Context context, Dataset datasetIn) {
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj3DNoiseCmd.class, false,
