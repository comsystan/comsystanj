 ...
 * File: Csaj3DSurrogateCmdUI.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
@Plugin(type = ContextCommand.class,
		...
		@Menu(label = "3D Surrogate(New Dialog)")})

public class Csaj3DSurrogateCmdUI extends ContextCommand implements Previewable{
	...
	private Csaj3DSurrogateDialog dialog = null;
	...
	public void run() {	
		...
		SwingUtilities.invokeLater(() -> {
			if (dialog == null) {
				dialog = new Csaj3DSurrogateDialog(context(), datasetIn);
			}
