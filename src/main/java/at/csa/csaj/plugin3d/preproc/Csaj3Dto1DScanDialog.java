 ...
 * File: Csaj3Dto1DScanDialog.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 */
public class Csaj3Dto1DScanDialog extends CsajDialog_3DPlugin {

	private static final long serialVersionUID = -8236313307794465024L;
	 ...
	 * Create the dialog.
	 */
	public Csaj3Dto1DScanDialog(Context context, Dataset datasetIn) {
		...
		//Title of plugin
		//Overwrite
		setTitle("3D to 1D scan");

		//Add specific GUI elements according to Command @Parameter GUI elements
	    //*****************************************************************************************		
	    JLabel labelScanType = new JLabel("Scan type");
	    labelScanType.setToolTipText("Type of 3D to 1D scanning");
	    labelScanType.setHorizontalAlignment(JLabel.RIGHT);
		
		String options[] = {"Hilbert", "Meander", "Random"};
		comboBoxScanType = new JComboBox<String>(options);
		comboBoxScanType.setToolTipText("Type of 3D to 1D scanning");
	...
	public void processCommand() {
		...
		Future<CommandModule> future = commandService.run(Csaj3Dto1DScanCmd.class, false,
		...
		tableOutName = Csaj3Dto1DScanCmd.TABLE_OUT_NAME;
