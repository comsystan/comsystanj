...
package at.csa.csaj.plugin1d.preproc.math;
...
public class Csaj1DMathematics<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DMathematics.class, true);
	}
}
