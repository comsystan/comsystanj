...
package at.csa.csaj.plugin1d.eval.autocorr;
...
public class Csaj1DAutoCorrelation<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
