 ...
 * File: Plugin2DFractalDimensionCorrelation.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * #L%
 */
package at.csa.csaj.plugin2d.frac.dim.correlation;
...
public class Plugin2DFractalDimensionCorrelation<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			//This dose not work with DisplayService because the JFrame is not "registered" as an ImageJ display	
	...
	*/
	...
	private double[] process(RandomAccessibleInterval<?> rai, int plane) { //plane plane (Image) number
		...
		//Sarkar & Chaudhuri „Multifractal and Generalized Dimensions of Gray-Tone Digital Images“. Sequence Processing 42, Nr. 2 (1. März 1995): 181–90. https://doi.org/10.1016/0165-1684(94)00126-K.
...
//					else if (scanningType.equals("Sliding box")) delta = 1;
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DFractalDimensionCorrelation.class, true);
	}
}
