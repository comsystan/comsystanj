...
public class Csaj2DFractalDimensionGeneralized<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				imgDil = (Img<FloatType>) opService.filter().convolve(imgBin, avgKernel, oobf);
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Csaj2DFractalDimensionGeneralized.class, true);
	}
}
