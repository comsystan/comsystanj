 ...
 * File: Plugin2DFractalDimensionGeneralized.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin2d.frac.dim.generalized;
...
@Plugin(type = ContextCommand.class, 
        ...
        @Menu(label = "Generalized dimensions", weight = 80)})
//public class Img2DFractalDimensionGeneralized<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Plugin2DFractalDimensionGeneralized<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				imgDil = (Img<FloatType>) opService.filter().convolve(imgBin, avgKernel, oobf);
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DFractalDimensionGeneralized.class, true);
	}
}
