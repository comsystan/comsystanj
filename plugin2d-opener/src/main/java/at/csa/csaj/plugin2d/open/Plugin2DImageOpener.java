 ...
 * #L%
 */
package at.csa.csaj.plugin2d.open;
...
public class Plugin2DImageOpener<T extends RealType<T>> extends ContextCommand { //modal GUI with cancel
...
//       
         //invoke the plugin
         ij.command().run(Plugin2DImageOpener.class, true);
