 ...
 * File: Higuchi2D_RGBDiff_KfoldDiff.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class Higuchi2D_RGBDiff_KfoldDiff implements Higuchi2DMethods{
	 ...
	 */
	public Higuchi2D_RGBDiff_KfoldDiff(RandomAccessibleInterval<?> rai, int numK, boolean skipZeroes)  {
		this.rai   = rai;
		this.numK  = numK;
		this.skipZeroes = skipZeroes;
	}

	public Higuchi2D_RGBDiff_KfoldDiff() {
	}
