/*-
 * #%L
 * Project: ImageJ2 sequence plugin for computing statistics.
 ...
 * #L%
 */
package at.csa.csaj.plugin1d.stat;
...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Statistics ", weight = 100)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
//public class SequenceStatistics<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DStatistics<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllColumns;
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new WaitingDialogWithProgressBar("Computing sequence statistics, please wait... Open console window for further info.",
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DStatistics.class, true);
	}
}
