 ...
 * #L%
 */
package at.csa.csaj.plugin1d.eval.stat;
...
public class Csaj1DStatistics<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllColumns;
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DStatistics.class, true);
	}
}
