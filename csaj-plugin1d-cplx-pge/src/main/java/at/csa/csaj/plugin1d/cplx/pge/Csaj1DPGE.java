/*-
  * #%L
 * Project: ImageJ2 signal plugin for Porta, Guzik, and Ehler indices using distances in the Poincare plot.
 * File: Csaj1DPGE.java
 * 
 * $Id$
 * $HeadURL$
 ...
 * #L%
 */
package at.csa.csaj.plugin1d.cplx.pge;
...
import at.csa.csaj.plugin1d.cplx.pge.util.PortaGuzikEhler;

/**
 * A {@link Command} plugin computing <Porta, Guzik, and Ehler indices</a>
 * of a  sequence.
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Porta Guzik Ehler indices ", weight = 147)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
...
//	}
	...
	*/
	protected void startWorkflowForSingleColumn() {
		...
		dlgProgress = new WaitingDialogWithProgressBar("Computing Porta Guzik Ehler indices, please wait... Open console window for further info.",
...
//			}
	...
	private void processSingleInputColumn (int c) {
		...
		if (resultValues != null) {
			logService.info(this.getClass().getName() + " Porta index: " + resultValues[0]);
			logService.info(this.getClass().getName() + " Guzik index: " + resultValues[1]);
			logService.info(this.getClass().getName() + " Ehler index: " + resultValues[2]);
		}
