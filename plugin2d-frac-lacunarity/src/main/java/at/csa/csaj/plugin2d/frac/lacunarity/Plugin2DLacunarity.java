 ...
 * #L%
 */
package at.csa.csaj.plugin2d.frac.lacunarity;
...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Lacunarity", weight = 130)})
//public class Img2DLacunarity<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Plugin2DLacunarity<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//							}
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DLacunarity.class, true);
	}
}
