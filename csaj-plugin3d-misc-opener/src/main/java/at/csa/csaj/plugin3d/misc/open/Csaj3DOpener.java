 ...
 * #L%
 */
package at.csa.csaj.plugin3d.misc.open;
...
public class Csaj3DOpener<T extends RealType<T>> extends ContextCommand { //modal GUI with cancel
    ...
    public void run() {
		...
		WaitingDialogWithProgressBar dlgProgress = new WaitingDialogWithProgressBar("Opening image volume, please wait... Open console window for further info.",
