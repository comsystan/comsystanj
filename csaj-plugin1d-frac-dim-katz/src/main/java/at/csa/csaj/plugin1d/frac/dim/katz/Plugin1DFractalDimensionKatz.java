/*-
 * #%L
 * Project: ImageJ2 sequence plugin for computing fractal dimension with Katz algorithm.
...
package at.csa.csaj.plugin1d.frac.dim.katz;
...
import at.csa.csaj.plugin1d.frac.dim.katz.util.Katz;
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Katz dimension ", weight = 180)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
//public class SequenceFractalDimensionKatz<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DFractalDimensionKatz<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DFractalDimensionKatz.class, true);
	}
}
