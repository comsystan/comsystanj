...
public class Csaj1DFractalDimensionKatz<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	private void processSingleInputColumn (int c) {
		...
		// 0 D, 1 R2, 2 StdErr
		logService.info(this.getClass().getName() + " Katz dimension: " + resultValues[0]);
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DFractalDimensionKatz.class, true);
	}
}
