 ...
 * #L%
 */
package at.csa.csaj.plugin3d.frac.lacunarity.util;
...
public class Lacunarity3D_Grey implements Lacunarity3DMethods{
	 ...
	 */
	public Lacunarity3D_Grey(RandomAccessibleInterval<?> rai, int numBoxes, String scanningType, String colorModelType, int pixelPercentage, WaitingDialogWithProgressBar dlgProgress, StatusService statusService) {
		this.rai             = rai;
