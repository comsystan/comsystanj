 ...
 * File: Csaj1DKolmogorovComplexity.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin1d.cplx.kc;
...
public class Csaj1DKolmogorovComplexity<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllColumns;
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DKolmogorovComplexity.class, true);
	}
}
