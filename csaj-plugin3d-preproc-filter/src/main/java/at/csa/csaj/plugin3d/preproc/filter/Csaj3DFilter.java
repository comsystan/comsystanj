/*-
 * #%L
 * Project: ImageJ2 plugin for filtering in 3D
...
package at.csa.csaj.plugin3d.preproc.filter;
...
@Menu(label = "3D Filter", weight = 15)})
//public class Csaj3DFilter<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj3DFilter<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			datasetPreview.setColorTable(ColorTables.BLUE,  2);
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new WaitingDialogWithProgressBar("3D filtering, please wait... Open console window for further info.",
