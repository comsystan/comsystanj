...
package at.csa.csaj.plugin1d.preproc.resampling;
...
public class Csaj1DResampling<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DResampling.class, true);
	}
}
