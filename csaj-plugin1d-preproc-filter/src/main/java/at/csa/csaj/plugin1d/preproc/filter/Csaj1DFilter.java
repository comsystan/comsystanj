...
package at.csa.csaj.plugin1d.preproc.filter;
...
public class Csaj1DFilter<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
