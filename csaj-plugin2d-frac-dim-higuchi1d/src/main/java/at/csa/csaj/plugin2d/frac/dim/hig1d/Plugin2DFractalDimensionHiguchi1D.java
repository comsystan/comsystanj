/*-
 * #%L
 * Project: ImageJ2 plugin for computing fractal dimension with 1D Higuchi algorithm.
 * File: Plugin2DFractalDimensionHiguchi1D.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin2d.frac.dim.hig1d;
...
public class Plugin2DFractalDimensionHiguchi1D<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//							|| (anglesRad[a] == 179)) { //show some plots
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DFractalDimensionHiguchi1D.class, true);
	}
}
