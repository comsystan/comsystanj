 ...
 * #L%
 */
package at.csa.csaj.plugin2d.kc;
...
public class Plugin2DKolmogorovComplexity<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		ldCorr     = ldCorr     * 1000.0;
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DKolmogorovComplexity.class, true);
	}
}
