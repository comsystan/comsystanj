...
package at.csa.csaj.plugin3d.generate;
...
public class Plugin3DVolumeGenerator<T extends RealType<T>, C> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//       
         //invoke the plugin
         ij.command().run(Plugin3DVolumeGenerator.class, true);
