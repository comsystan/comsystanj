 ...
 * #L%
 */
package at.csa.csaj.img2d.surrogate;
...
public class Img2DImageSurrogate<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Img2DImageSurrogate.class, true);
	}
}
