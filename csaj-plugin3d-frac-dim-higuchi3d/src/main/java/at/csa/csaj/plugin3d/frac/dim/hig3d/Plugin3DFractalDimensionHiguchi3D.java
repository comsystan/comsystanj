 ...
 * File: Plugin3DFractalDimensionHiguchi3D.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin3d.frac.dim.hig3d;
...
import at.csa.csaj.plugin3d.frac.dim.hig3d.util.Higuchi3DMethods;
import at.csa.csaj.plugin3d.frac.dim.hig3d.util.Higuchi3D_Grey_DirDiff;
import at.csa.csaj.plugin3d.frac.dim.hig3d.util.Higuchi3D_Grey_MultDiff;
import at.csa.csaj.plugin3d.frac.dim.hig3d.util.Higuchi3D_Grey_SqrDiff;
...
public class Plugin3DFractalDimensionHiguchi3D<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin3DFractalDimensionHiguchi3D.class, true);
	}
}
