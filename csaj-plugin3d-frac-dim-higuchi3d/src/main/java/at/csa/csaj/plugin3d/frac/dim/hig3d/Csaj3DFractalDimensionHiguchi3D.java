...
public class Csaj3DFractalDimensionHiguchi3D<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Csaj3DFractalDimensionHiguchi3D.class, true);
	}
}
