...
public class Csaj3DFractalDimensionFFT<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				System.out.println("sumPower8: " + sumPowers8);
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Csaj3DFractalDimensionFFT.class, true);
	}
}
