 ...
 * File: Plugin3DFractalDimensionFFT.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin3d.frac.dim.fft;
...
/**
 * A {@link ContextCommand} plugin computing <the 3D FFT dimension</a>
 * of an image volume.
 */
...
@Menu(label = "3D FFT dimension", weight = 60)})
//public class Img3DFractalDimensionFFT<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin3DFractalDimensionFFT<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	private void processSingleInputVolume() {
		...
		if       (choiceRadioButt_PowerSpecType.equals("Spherical average")) {
			dim = (11.0 + regressionValues[1])/2.0;
		}
...
//				System.out.println("sumPower8: " + sumPowers8);
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Img3DFractalDimensionFFT.class,
		// true).get().getOutput("image");
		ij.command().run(Plugin3DFractalDimensionFFT.class, true);
	}
}
