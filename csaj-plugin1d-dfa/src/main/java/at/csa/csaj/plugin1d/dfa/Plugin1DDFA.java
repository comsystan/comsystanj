 ...
 * #L%
 */
package at.csa.csaj.plugin1d.dfa;
...
import at.csa.csaj.plugin1d.dfa.util.DFA;
...
public class Plugin1DDFA<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DDFA.class, true);
	}
}
