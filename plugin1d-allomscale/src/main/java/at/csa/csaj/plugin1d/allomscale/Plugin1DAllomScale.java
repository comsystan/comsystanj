/*-
 * #%L
 * Project: ImageJ2 sequence plugin for allometric scaling
 * File: Plugin1DAllomScale.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * #L%
 */
package at.csa.csaj.plugin1d.allomscale;
...
import at.csa.csaj.plugin1d.allomscale.util.AllometricScaling;
...
//public class SequenceAllomScale<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DAllomScale<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DAllomScale.class, true);
	}
}
