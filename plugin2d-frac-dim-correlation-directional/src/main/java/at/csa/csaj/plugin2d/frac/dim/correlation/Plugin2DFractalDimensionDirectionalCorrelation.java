 ...
 * File: Plugin2DFractalDimensionDirectionalCorrelation.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class Plugin2DFractalDimensionDirectionalCorrelation<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		// 0 Ds-row, 1 R2-row, 2 StdErr-row, 3 Ds-col, 4 R2-col, 5 StdErr-col, 6 Ds, 7 R2, 8 Stderr
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DFractalDimensionDirectionalCorrelation.class, true);
	}
}
