 ...
 * #L%
 */
package at.csa.csaj.plugin1d.detect.qrspeaks;
...
import at.csa.csaj.plugin1d.detect.qrspeaks.util.QRSPeaksDetector;
import at.csa.csaj.plugin1d.detect.qrspeaks.util.QRSPeaksDetectorFileOpenDialog;
...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "QRS peaks detection (from file) ", weight = 120)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
public class Plugin1DDetectQRSPeaks  extends ContextCommand implements Previewable { //modal GUI with cancel
...
//       
         //invoke the plugin
         ij.command().run(Plugin1DDetectQRSPeaks.class, true);
