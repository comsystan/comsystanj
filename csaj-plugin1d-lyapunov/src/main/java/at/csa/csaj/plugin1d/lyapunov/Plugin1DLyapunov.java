 ...
 * #L%
 */
package at.csa.csaj.plugin1d.lyapunov;
...
import at.csa.csaj.plugin1d.lyapunov.util.Lyapunov;
...
public class Plugin1DLyapunov<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DLyapunov.class, true);
	}
}
