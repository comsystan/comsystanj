 ...
 * File: Plugin1DFractalDimensionSevcik.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
public class Plugin1DFractalDimensionSevcik<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DFractalDimensionSevcik.class, true);
	}
}
