 ...
 * File: Csaj1DFractalDimensionSevcik.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin1d.frac.dim.sevcik;
...
//public class SequenceFractalDimensionSevcik<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Csaj1DFractalDimensionSevcik<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	private void processSingleInputColumn (int c) {
		...
		// 0 D, 1 R2, 2 StdErr
		logService.info(this.getClass().getName() + " Sevcik dimension: " + resultValues[0]);
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DFractalDimensionSevcik.class, true);
	}
}
