...
public class Csaj1DFractalDimensionTugOfWar<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DFractalDimensionTugOfWar.class, true);
	}
}
