/*-
 * #%L
 * Project: ImageJ2 sequence plugin for symbolic aggregation
...
package at.csa.csaj.plugin1d.symbolicaggregation;
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Symbolic aggregation ", weight = 350)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
//public class SequenceSymbolicAggregation<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DSymbolicAggregation<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				}	
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DSymbolicAggregation.class, true);
	}
}
