...
package at.csa.csaj.plugin1d.en.sampen;
...
import at.csa.csaj.plugin1d.en.sampen.util.ApproximateEntropy;
import at.csa.csaj.plugin1d.en.sampen.util.SampleEntropy;
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "Sample entropy ", weight = 300)})
//public class SequenceSampleEntropy<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DSampleEntropy<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DSampleEntropy.class, true);
	}
}
