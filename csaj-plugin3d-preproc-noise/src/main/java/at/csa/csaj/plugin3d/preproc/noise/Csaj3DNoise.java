/*-
 * #%L
 * Project: ImageJ2 plugin for adding noise in 3D
...
package at.csa.csaj.plugin3d.preproc.noise;
...
//			datasetPreview.setColorTable(ColorTables.BLUE,  2);
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new WaitingDialogWithProgressBar("3D adding noise, please wait... Open console window for further info.",
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		// ij.command().run(Csaj3DNoise.class,
		// true).get().getOutput("image");
		ij.command().run(Csaj3DNoise.class, true);
	}
}
