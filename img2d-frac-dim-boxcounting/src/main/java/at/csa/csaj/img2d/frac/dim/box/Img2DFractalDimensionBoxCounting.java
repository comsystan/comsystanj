...
public class Img2DFractalDimensionBoxCounting<T extends RealType<T>> extends InteractiveCommand implements Command, Previewable { //non blocking GUI
//public class Img2DFractalDimensionBoxCounting<T extends RealType<T>> implements Command {	//modal GUI
