...
public class Csaj2DFractalDimensionMinkowski<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}//b
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Csaj2DFractalDimensionMinkowski.class, true);
	}
}
