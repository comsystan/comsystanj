...
package at.csa.csaj.plugin2d.frac.dim.minkowski;
...
public class Plugin2DFractalDimensionMinkowski<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}//b
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DFractalDimensionMinkowski.class, true);
	}
}
