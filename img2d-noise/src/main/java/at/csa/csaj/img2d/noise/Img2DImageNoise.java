 ...
 * #L%
 */
package at.csa.csaj.img2d.noise;
...
public class Img2DImageNoise<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Img2DImageNoise.class, true);
	}
}
