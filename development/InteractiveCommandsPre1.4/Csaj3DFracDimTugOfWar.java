...
/**
 * A {@link InteractiveCommand} plugin computing <the 3D fractal Tug of war dimension</a>
 * of an image volume.
 */
 ...
 *
 */
public class Csaj3DFracDimTugOfWar<T extends RealType<T>> extends InteractiveCommand implements Previewable {
...
//	}
	...
	*/
	protected void startWorkflowForSingleVolume() {
		...
		dlgProgress = new CsajDialog_WaitingWithProgressBar("Computing 3D Tug of war dimension, please wait... Open console window for further info.",
