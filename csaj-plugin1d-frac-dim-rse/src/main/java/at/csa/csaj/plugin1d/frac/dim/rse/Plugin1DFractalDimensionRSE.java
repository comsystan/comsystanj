 ...
 * #L%
 */
package at.csa.csaj.plugin1d.frac.dim.rse;
...
import at.csa.csaj.plugin1d.frac.dim.rse.util.RSE;
...
@Plugin(type = ContextCommand.class, 
	...
	@Menu(label = "RSE dimension ", weight = 210)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
//public class SequenceFractalDimensionRSE<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DFractalDimensionRSE<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DFractalDimensionRSE.class, true);
	}
}
