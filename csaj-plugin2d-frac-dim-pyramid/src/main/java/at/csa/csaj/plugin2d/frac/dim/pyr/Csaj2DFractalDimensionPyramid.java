...
public class Csaj2DFractalDimensionPyramid<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				meanRq = meanRq /numRq;
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Csaj2DFractalDimensionPyramid.class, true);
	}
}
