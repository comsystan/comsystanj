 ...
 * File: Plugin2DFractalDimensionPyramid.java
 * 
 * $Id$
 * $HeadURL$
 * 
 ...
 * #L%
 */
package at.csa.csaj.plugin2d.frac.dim.pyr;
...
@Plugin(type = ContextCommand.class, 
        ...
        @Menu(label = "Pyramid dimension", weight = 40)})
//public class Img2DFractalDimensionPyramid<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Plugin2DFractalDimensionPyramid<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//				meanRq = meanRq /numRq;
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DFractalDimensionPyramid.class, true);
	}
}
