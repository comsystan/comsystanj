 ...
 * #L%
 */
package at.csa.csaj.plugin1d.generate;
...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Sequence generator ", weight = 10)}) //Space at the end of the label is necessary to avoid duplicate with image2d plugin 
public class Plugin1DGenerator<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
 ...
 // This method removes NaN  from field sequence1D
    ...
    public void run() {
		...
		dlgProgress = new WaitingDialogWithProgressBar("Sequence generation, please wait... Open console window for further info.",
...
//       
         //invoke the plugin
         ij.command().run(Plugin1DGenerator.class, true);
