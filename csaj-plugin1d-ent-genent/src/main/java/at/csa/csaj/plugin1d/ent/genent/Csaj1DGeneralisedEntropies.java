...
package at.csa.csaj.plugin1d.ent.genent;
...
public class Csaj1DGeneralisedEntropies<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllColumns;
	...
	*/
	...
	private void processSingleInputColumn (int c) {
		...
		// 0 Entropy
		logService.info(this.getClass().getName() + " Gen entropy SE: " + resultValues[0]);
...
//        }
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DGeneralisedEntropies.class, true);
	}
}
