/*-
 * #%L
 * Project: ImageJ2 sequence plugin for down- and upsampling
...
package at.csa.csaj.plugin1d.resampling;
...
//public class SequenceResampling<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DResampling<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
	...
	private void processSingleInputColumn (int s) {
		...
		//if (selectedOption == JOptionPane.YES_OPTION) {
			if (resultValues != null) { 
				...
				SequencePlotFrame pdf = new SequencePlotFrame(tableOut, cols, isLineVisible, "Sequence(s)", sequenceTitle, xLabel, yLabel, seriesLabels);
				pdf.setVisible(true);
			}
		//}
...
//		}
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DResampling.class, true);
	}
}
