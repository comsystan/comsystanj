 ...
 * #L%
 */
package at.csa.csaj.plugin2d.frac.succolarity;
...
@Plugin(type = ContextCommand.class,
	...
	@Menu(label = "Succolarity", weight = 140)})
//public class Img2DSuccolarity<T extends RealType<T>> extends InteractiveCommand { //non blocking GUI
public class Plugin2DSuccolarity<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//		succ[0] = succ[0]/((double)numOfScannedBoxes*1*maxPR);
	...
	public static void main(final String... args) throws Exception {
		...
		ij.command().run(Plugin2DSuccolarity.class, true);
	}
}
