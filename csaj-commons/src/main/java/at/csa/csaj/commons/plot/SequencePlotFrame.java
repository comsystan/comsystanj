 ...
 */
public class SequencePlotFrame extends CSAJPlotFrame {
	...
	public SequencePlotFrame(DefaultGenericTable defaultGenericTable, int col, boolean isLineVisible,
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public SequencePlotFrame(DefaultGenericTable defaultGenericTable, int[] cols,
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public SequencePlotFrame(double[] dataX, DefaultGenericTable defaultGenericTable, int col, boolean isLineVisible,
			String frameTitle, String imageTitle, String xLabel, String yLabel) {
		super(frameTitle);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public SequencePlotFrame(double[] dataX, DefaultGenericTable defaultGenericTable, int[] cols,
			boolean isLineVisible, String frameTitle, String imageTitle,
			String xLabel, String yLabel, String[] seriesLabels) {
		super(frameTitle);
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public SequencePlotFrame(double dataX[], double[] dataY,
			boolean isLineVisible, String frameTitle, String imageTitle,
	 ...
	 */
	@SuppressWarnings("rawtypes")
	public SequencePlotFrame(double dataX[], double[] dataY,  double[] dataX2, double[] dataY2,
			boolean isLineVisible, String frameTitle, String imageTitle,
