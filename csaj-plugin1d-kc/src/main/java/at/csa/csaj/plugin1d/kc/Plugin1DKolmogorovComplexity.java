/*-
 * #%L
 * Project: ImageJ2 sequence plugin for computing the Kolmogorov complexity and Logical depth
 * File: Plugin1DKolmogorovComplexity.java
 * 
 * $Id$
 * $HeadURL$
 * 
...
package at.csa.csaj.plugin1d.kc;
...
//public class SequenceKolmogorovComplexity<T extends RealType<T>> extends InteractiveCommand { // non blocking  GUI
public class Plugin1DKolmogorovComplexity<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//	private Button buttonProcessAllColumns;
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Plugin1DKolmogorovComplexity.class, true);
	}
}
