 ...
 * #L%
 */
package at.csa.csaj.plugin1d.cplx.allomscale;
...
import at.csa.csaj.plugin1d.cplx.allomscale.util.AllometricScaling;
...
public class Csaj1DAllomScale<T extends RealType<T>> extends ContextCommand implements Previewable { //modal GUI with cancel
...
//			}
	...
	private void processSingleInputColumn (int c) {
		...
		// 0 Dh, 1 R2, 2 StdErr
		logService.info(this.getClass().getName() + " Slope: " + resultValues[0]);
	...
	*/
	...
	public static void main(final String... args) throws Exception {
		...
		//open and run Plugin
		ij.command().run(Csaj1DAllomScale.class, true);
	}
}
